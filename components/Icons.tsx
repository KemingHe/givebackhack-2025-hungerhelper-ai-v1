...
export const BrainIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 14.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5zM15 9.5a2.5 2.5 0 100-5 2.5 2.5 0 000 5z" opacity="0.5" />
    </svg>
);
...
export const UserIcon: React.FC = () => <i className="fas fa-user text-sm"></i>;
export const BotIcon: React.FC = () => <i className="fas fa-robot text-sm"></i>;
export const WebIcon: React.FC = () => <i className="fas fa-globe"></i>;
export const MapIcon: React.FC = () => <i className="fas fa-map-location-dot"></i>;
export const MicIcon: React.FC = () => <i className="fas fa-microphone"></i>;